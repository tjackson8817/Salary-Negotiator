...
1. **Market Data Snapshot** — real, current compensation research for the role, seniority level, and location, sourced from actual places (levels.fyi, Glassdoor, Payscale, BLS data, comparable disclosed postings). Never a guessed number presented as if it were sourced.
